...
[stuff to add - make sure caps on cardinal directions are correct, check to see if they have the package when leaving, stop them from taking the wrap, figure out a better way to do 'enter' on the main buildings. Make the postage machine actually work, award points if the player buys postage ahead of time.]
